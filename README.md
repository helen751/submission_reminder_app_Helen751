...
2. \`\`\*\* Based on User Input - Launches Startup\*\*
...
```bash
./submisison_reminder_{yourname}/startup.sh
```
...
- `Aside the helper function given inside `functions.sh`, I added 1 more function for the user menu option navigation
